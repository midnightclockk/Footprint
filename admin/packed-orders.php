...
<html lang="en">
    <head>
        ...
        <title>Shopping Portal | Manage Packed Orders</title>
...
<?php $cnt=$cnt+1; } ?>
<?php if (!$orderFound): ?>
    <tr><td colspan="9" style="text-align:center; font-size:18px; color:#c00; font-weight:bold;">Order is not packed yet.</td></tr>
<?php endif; ?>
                                    </tbody>
                                </table>
                                </div>
