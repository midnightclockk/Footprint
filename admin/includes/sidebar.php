            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <button class="btn btn-close-sidebar d-lg-none" id="sidebarCloseBtn" aria-label="Close sidebar" style="position:absolute;top:10px;right:10px;font-size:2rem;background:none;border:none;color:#fff;z-index:1040;display:block;">&times;</button>
...
?>
<a class="nav-link" href="todays-orders.php">Today's Orders</a>
<a class="nav-link" href="pending-orders.php">Pending Orders</a>
<a class="nav-link" href="delivered-orders.php">Delivered Orders</a>
...
<div id="sidebarOverlay" class="d-lg-none" style="display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.5);z-index:1037;"></div>