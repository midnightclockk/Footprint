...
if(isset($_POST['submit']))
{
	...
	$productimage1 = mysqli_real_escape_string($con, $_FILES["productimage1"]["name"]);
	$productimage2 = mysqli_real_escape_string($con, $_FILES["productimage2"]["name"]);
	$productimage3 = mysqli_real_escape_string($con, $_FILES["productimage3"]["name"]);
