...
<div style="margin-top: 20px;">
    <button type="submit" name="submit" class="btn btn-primary" style="margin-right: 10px;">Update</button>
    <a href="edit-products.php?id=<?php echo $pid; ?>" class="btn btn-danger">Back</a>
</div>
</div>
</div>
