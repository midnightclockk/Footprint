...
if (isset($_SESSION['cart_alert']) && $_SESSION['cart_alert']) {
    echo "<script>alert('Product has been added to the cart');</script>";
...
?>
					...
					<div class="products">
						...
						<div class="cart clearfix animate-effect">
							...
							<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>&pid=<?php echo $row['id']; ?>" class="btn btn-primary">Add to cart</a>
								<?php } else {?>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="#" class="btn btn-primary" id="add-to-cart-btn" onclick="addToCart(<?php echo $row['id']; ?>); return false;"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
										<a href="#" class="btn btn-success" id="buy-now-btn" onclick="buyNow(<?php echo $row['id']; ?>); return false;" style="margin-left:10px;"><i class="fa fa-bolt"></i> BUY NOW</a>
<?php } else {?>
							<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
									</div>
				...
				<div class="action">
					<ul class="list-unstyled">
						<li class="add-cart-button btn-group">
							...
							<a href="#" class="lnk btn btn-primary" onclick="addToCart(<?php echo $rw['id']; ?>); return false;">Add to cart</a>
						</li>
						<li class="lnk wishlist">
							<a class="add-to-cart" href="category.php?pid=<?php echo htmlentities($rw['id'])?>&&action=wishlist" title="Wishlist">
...
<?php include('includes/footer.php');?>
	...
	<!-- Re-initialize Owl Carousel for product gallery -->
	<script src="assets/js/jquery-1.11.1.min.js"></script>
	<script src="assets/js/owl.carousel.min.js"></script>
	<script>
	$(document).ready(function(){
		// Diagnostic: Print gallery structure
		console.log('--- Owl Carousel Diagnostic ---');
		var gallery = $('#owl-single-product');
		if (gallery.length) {
			console.log('Gallery container found:', gallery[0]);
			console.log('Direct children:', gallery.children());
			gallery.children().each(function(i, el){
				console.log('Child', i, 'class:', el.className, 'id:', el.id);
			});
		} else {
			console.error('Gallery container #owl-single-product NOT found!');
		}
		// Diagnostic: Check for Owl Carousel
		if (typeof $.fn.owlCarousel === 'function') {
			console.log('Owl Carousel plugin is loaded.');
		} else {
		...
		try {
			...
			console.error('Owl Carousel initialization error:', e);
		}
	});
	</script>
