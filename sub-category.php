...
$subcat_name = '';
$subcat_title_query = mysqli_query($con, "SELECT subcategory FROM subcategory WHERE id='$cid'");
if ($subcat_title_row = mysqli_fetch_array($subcat_title_query)) {
    $subcat_name = htmlentities($subcat_title_row['subcategory']);
}
...
<html lang="en">
	<head>
	    ...
	    <title><?php echo $subcat_name;?> | Footprint</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'><?php echo $subcat_name;?></li>
			</ul>
	    ...
	    <?php } ?>
				...
				<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
					...
					<div class="sidebar-widget-body m-t-10">
						<div class="accordion">
					            <?php 
					            $sql_subcat = mysqli_query($con,"select id,subcategory from subcategory where categoryid=(select category from products where id='$cid')");
					            while($row_subcat = mysqli_fetch_array($sql_subcat))
					            {
					            ?>
							<div class="accordion-group">
						            <div class="accordion-heading">
						                <a href="sub-category.php?scid=<?php echo $row_subcat['id'];?>"  class="accordion-toggle collapsed">
