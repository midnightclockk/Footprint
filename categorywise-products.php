...
<html lang="en">
    <head>
        ...
        <title>FootPrint | <?php echo htmlentities($brandName);?> Products</title>
        <!-- Favicon-->
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder"><?php echo htmlentities($brandName);?> Products</h1>
...
if(isset($_GET['brand'])) {
    $brandName = $_GET['brand'];
    $query=mysqli_query($con,"select products.id as pid,products.productImage1,products.productName,products.productPriceBeforeDiscount,products.productPrice from products where productCompany='$brandName' order by pid desc  ");
}
else {
    // Fallback if brand is not set, maybe show all products or redirect
    $query=mysqli_query($con,"select products.id as pid,products.productImage1,products.productName,products.productPriceBeforeDiscount,products.productPrice from products order by pid desc  ");
}
