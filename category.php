...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	// Redirect to the same category page without action parameter
	$redirectUrl = strtok($_SERVER["REQUEST_URI"], '?');
	if(isset($_GET['cid'])) {
		$redirectUrl .= '?cid=' . intval($_GET['cid']);
	}
...
{
    ?>
                <a href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="icon fas fa-shoe-prints fa-fw"></i>
				...
				<div class="action">
					...
					<?php } ?>
		                ...
		                <li class="lnk wishlist">
							<a href="#" class="add-to-wishlist" title="Wishlist" onclick="addToWishlist(<?php echo htmlentities($row['id']); ?>); return false;">
