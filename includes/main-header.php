...
<div class="logo">
	<a href="index.php">
		<span class="foot-text">Foot</span><span>Print.</span>
...
if(!empty($_SESSION['cart'])){
	?>
	<div class="dropdown dropdown-cart" id="main-cart-dropdown">
		<a href="my-cart.php" class="lnk-cart" id="cart-link">
...
<style>
#main-cart-dropdown.open > .dropdown-menu {
    display: block;
}
#main-cart-dropdown .dropdown-menu {
    display: none;
    left: 0;
    right: auto;
}
...
document.addEventListener('DOMContentLoaded', function() {
    var cartDropdown = document.getElementById('main-cart-dropdown');
    ...
    cartLink.addEventListener('click', function(e) {
        // Let the default action (go to my-cart.php) happen
    });
});
</script>